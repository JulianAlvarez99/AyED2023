...
vector_t* vector_new(int ini_size)
{
    ...
    vector ->Size = 0;                                          // el tamaño actual del vector es cero
    vector->MAX_size = ini_size;                                // el tamaño máximo del vector es el valor recibido como parámetro
...
/**
 * @brief Permite agregar un elemento en una posición determinada.Devuelve 0 si pudo agregarlo y 1 si no pudo.
 *
 * @param v
 * @param index
 * @param value
